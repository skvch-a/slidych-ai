...
const UploadPage = () => {
  ...
  const handleDocumentProcessing = async () => {
    setLoadingState({
      ...
      showProgress: true,
      duration: 90,
      extra_info: files.length > 0 ? "Для больших документов может понадобится несколько минут." : "",
    });
  ...
  return (
    <Wrapper className="pb-10 lg:max-w-[70%] xl:max-w-[65%]">
      ...
      <Button
        ...
        className="w-full rounded-[32px] flex items-center justify-center py-6 bg-[#003174] text-white font-instrument_sans font-semibold text-xl hover:bg-[#003174]/80 transition-colors duration-300"
