...
export const metadata: Metadata = {
  metadataBase: new URL("https://slidych.ai"),
  title: "Слайдыч",
  description:
  ...
  openGraph: {
    ...
    description:
      "Open-source AI presentation generator with custom layouts, multi-model support (OpenAI, Gemini, Ollama), and PDF/PPTX export. A free Gamma alternative.",
    url: "https://slidych.ai",
    siteName: "Слайдыч",
    images: [
      {
        url: "https://slydich.ai/slydich-feature-graphics.png",
        width: 1200,
        height: 630,
        alt: "Slydich Logo",
      },
  ...
  twitter: {
    ...
    description:
      "Open-source AI presentation generator with custom layouts, multi-model support (OpenAI, Gemini, Ollama), and PDF/PPTX export. A free Gamma alternative.",
    images: ["https://slidych.ai/slidych-feature-graphics.png"],
  },
};
