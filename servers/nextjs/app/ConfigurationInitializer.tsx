    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-400 via-blue-600 to-blue-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="bg-white backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 text-center">
            {/* Logo/Branding */}
            <div className="mb-6">
              <img
                src="/Logo.png"
              ...
              />
              <div className="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-900 mx-auto rounded-full"></div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600 font-inter">
                Готовим слайдыча к продуктивной работе...
              </p>
            </div>
            ...
            <div className="mt-6">
              <div className="flex space-x-1 justify-center">
                ...
                <div className="w-2 h-2 bg-purple-900 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
