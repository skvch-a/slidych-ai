...
const Schema = z.object({
    ...
    content: z.string().min(400).max(800).default('С 2009 года — независимое заверение отчетности, проведение диалогов с заинтересованными сторонами. Переход на единый бренд «Росатома» в 2021 году.').meta({ description: 'Основной текстовый блок или параграф' })
});
